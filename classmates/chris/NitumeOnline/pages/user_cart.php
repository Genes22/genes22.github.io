      ...
      <table class="table table-condensed table-bordered">
              <thead>
                <tr>
                  ...
                  <th width="100">Price(Tshs)</th>
                  <th width="100">Total(Tshs)</th>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Delivering Address:</h4>
                  </div>
                  <div class="modal-body">
                      ...
                      <option value="Mbezi Luis">Mbezi Luis</option>
                      <option value="Gongo la mboto">Gongo la mboto</option>
                      <option value="Tabata">Tabata</option>
                      <option value="Bunju">Bunju</option>
