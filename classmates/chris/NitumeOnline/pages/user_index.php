            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/bg4.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        <img src="../assets/img/logo.png" alt="Circle Image" class="rounded-circle">
                        <br><br>
                        <h3>Welcome to Nitume App, Start Ordering Now</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    ?>   
                        <div class="row-sm-3">
                            ...
                            <div class="caption">
                              ...
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Tshs<?php echo $res['prod_price']; ?></medium></h6>
                            </div>
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You By <a href="https://code-projects.org/">nitume inc</a> | Thanks to Crispine and Dismas</li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
                    ...
                    </script>, Designed and Coded by Crispine and Dismas.
                </div>
            </div>
        </footer>
    </div>
