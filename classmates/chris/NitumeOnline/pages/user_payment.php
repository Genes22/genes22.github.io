...
$prod_qty=$row2['prod_qty'];
 ...
 if(mysqli_query($dbconn,"UPDATE products SET prod_qty = prod_qty - $qty WHERE prod_id ='$prod_id' AND prod_qty='$prod_qty'")){
  echo "cart updated";
}
...
$cart_table = mysqli_query($dbconn,"SELECT sum(total) FROM order_details WHERE user_id='$user_id' AND order_id=''") or die(mysqli_error());
       $cart_count = mysqli_num_rows($cart_table);
        ...
        while ($cart_row = mysqli_fetch_array($cart_table)) {
           ...
           echo 'Total: Tshs'.$total.' | ';
           echo 'Tax: Tshs'.$tax.' | '; 
           echo 'Delivery Address: '.$ship_add.' *********';
...
?>
        ...
        <h3>Delivery process time, minimum of Eight(8) hours and maximum of one(1) day.</h3><br>
        <h5>Nitume Online, Inc.</h5>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Crispin And Dismas.
                </div>
            </div>
        </footer>
    </div>
