...
<body style="background-image:url(&quot;assets/img/home.jpg&quot;);">
    ...
    <div class="login-dark" style="background-image:url(&quot;assets/img/home.jpg&quot;);height:511px;">
        <form action="includes/UpdateuContactadmin.inc.php" method="post" style="margin-top:-39px;background-color:rgba(30,40,51,0.67);">
            <h2 style="font-size:19px;margin-top:-22px;margin-bottom:45px;height:22px;"><strong>Update your infomation</strong></h2>
            <div class="form-group"><input class="form-control" type="text" name="uContact" placeholder="Enter new contact" autofocus="" style="background-color:#ffffff;color:rgb(0,0,0);"></div>
