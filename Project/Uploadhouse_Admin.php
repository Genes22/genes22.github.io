...
<body style="background-image:url(&quot;assets/img/home.jpg&quot;);">
    ...
    <div style="color:rgb(254,254,254);">
        ...
        <div class="container" style="padding-left:9px;width:756px;height:572px;">
            <div>
                <form class="flex-shrink-1 align-items-center flex-sm-shrink-1 align-items-sm-center align-content-sm-center flex-md-shrink-1 align-items-md-center align-content-md-center" action="includes/Uploadhouse_Admin.inc.php" method="post"
