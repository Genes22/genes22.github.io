...
<body style="background-image:url(&quot;assets/img/home.jpg&quot;);">
    ...
    <div class="login-dark" style="background-image:url(&quot;assets/img/home.jpg&quot;);height:511px;">
        <form action="includes/UpdateuMailadmin.inc.php" method="post" style="margin-top:-39px;background-color:rgba(30,40,51,0.67);">
            <h2 style="font-size:19px;margin-top:-22px;margin-bottom:45px;height:22px;"><strong>Update your infomation</strong></h2>
            <div class="form-group"><input class="form-control" type="text" name="uMail" placeholder="Enter new E-mail" autofocus="" style="background-color:#ffffff;color:rgb(0,0,0);"></div>
            <p class="text-monospace text-center" style="color:rgb(255,0,0);"><strong>Error Massges</strong></p>
            <div class="form-group"><button class="btn btn-primary active btn-block btn-sm" name="Update_umail" type="submit"><strong>Update</strong></button></div>
        </form>
    </div>
