        ...
        <div class="table-responsive" style="color:rgb(0,0,0);background-color:#ffffff;">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<tr>';
                    ...
                    echo '<td>'.$row['Area'].'</td>';
                    echo '<td><a class="btn btn-primary active btn-block" role="button" href="includes/Delete_godown.inc.php?Delete='.$row['Id'].'" data-bs-hover-animate="pulse" style="background-color:rgb(0,0,0);font-size:13px;color:rgb(255,0,0);"><strong>DELETE</strong></a></td>';
                echo '</tr>';
                echo '<tr>';
