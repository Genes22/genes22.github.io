...
<body>
        ...
        <nav class="navbar navbar-dark navbar-expand-md sticky-top navigation-clean-button" style="background-color:rgb(0,0,0);">
            <div class="container-fluid"><a class="navbar-brand" href="#" data-bs-hover-animate="pulse" style="background-repeat:no-repeat;background-size:cover;background-image:url(&quot;assets/img/Logo.jpg&quot;);width:217px;height:106px;"></a><button class="navbar-toggler" data-toggle="collapse"
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    </ul><span class="navbar-text actions"> <a class="btn btn-light active action-button" role="button" href="Signup.php"><strong>Sign Up</strong></a></span></div>
            </div>
        </nav>
    </div>
    <div class="login-dark" style="background-image:url(&quot;assets/img/home.jpg&quot;);">
        <form action="Signin.inc.php" method="post" style="background-color:rgba(30,40,51,0.68);margin-top:-294px;">
            <div class="form-group"><i class="icon ion-lock-combination"></i><input class="form-control" type="password" name="Newpassword" placeholder="Enter new password..." autofocus="" style="background-color:#ffffff;color:rgb(0,0,0);"><i class="icon ion-lock-combination"></i>
                <input
                    class="form-control" type="password" name="Newpassword" placeholder="Repeat new password..." autofocus="" style="background-color:#ffffff;color:rgb(0,0,0);margin-top:2px;"></div>
            <div class="form-group"><button class="btn btn-primary active btn-block btn-sm" type="submit" data-bs-hover-animate="rubberBand" style="height:35px;"><strong>RECEIVE NEW PASSWORD BY MAIL&nbsp;</strong></button></div>
        </form>
    </div>
