...
<body>
    ...
    <div class="login-dark" style="background-image:url(&quot;assets/img/home.jpg&quot;);">
        <form action="includes/Signin_Admin.inc.php" method="post" style="background-color:rgba(30,40,51,0.68);margin-top:-201px;">
            <h2 class="sr-only">Login Form</h2>
            <h3 style="margin-left:10px;margin-top:-37px;color:white;">
            ...
            if (isset($_GET["error"])) {
                ...
                <strong>Wrong Password!..</strong>
                    ...
                    echo '<p class="text-monospace text-center signin_error"
                id="signin_error" style="color:rgb(255,0,0);">
                <strong>Oops!..You"ve no authority to signin here!..</strong>
            </p>';
                }
            }
 ...
 ';
             ...
             ?>
            <!--<p class="text-monospace text-center signinadmin_error"
                id="signinadmin_error" style="color:rgb(255,0,0);">
                <strong>Error massages</strong></p>
            <p class="text-monospace text-center signinadmin_success" id="signinadmin_success" style="color:rgb(51,255,0);margin-top:-40px;"><strong>Error massages</strong>
            </p>-->
            <div class="form-group">
                <button class="btn btn-primary active btn-block btn-sm" type="submit" name="signin-admin-submit" data-bs-hover-animate="rubberBand" style="height:35px;">
        ...
        <footer>
            <div class="container">
                <div class="row">
                    ...
                    <a href="#" data-bs-hover-animate="rubberBand"><i class="icon ion-social-instagram">
