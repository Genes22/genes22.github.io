        ...
        <div class="table-responsive" style="background-color:#ffffff;color:rgb(0,0,0);">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<tr>';
                    ...
                    echo '<td><a class="btn btn-primary active btn-block" role="button" href="includes/Delete_hostel.inc.php?Delete='.$row['Id'].'" data-bs-hover-animate="pulse" style="background-color:rgb(0,0,0);font-size:15px;color:rgb(255,0,0);"><strong>DELETE</strong></a></td>';
                echo '</tr>';
                echo '<tr>';
